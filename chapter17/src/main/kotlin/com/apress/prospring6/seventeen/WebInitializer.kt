...
class WebInitializer : AbstractAnnotationConfigDispatcherServletInitializer() {
    ...
    override fun getServletConfigClasses() =
        arrayOf<Class<*>>(ApplicationConfiguration::class.java)
    ...
    public override fun customizeRegistration(registration: ServletRegistration.Dynamic) {
        with(registration) {
            ...
            setMultipartConfig(multipartConfigElement) // <=> <multipart-config>
        }
        super.customizeRegistration(registration)
    }

    private val multipartConfigElement = MultipartConfigElement(null, MAX_FILE_SIZE, MAX_REQUEST_SIZE, FILE_SIZE_THRESHOLD)
