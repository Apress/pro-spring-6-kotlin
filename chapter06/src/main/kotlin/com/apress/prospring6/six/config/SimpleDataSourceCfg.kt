...
open class SimpleDataSourceCfg {
    ...
    open fun dataSource(): DataSource? {
        return try {
            val driver = Class.forName(driverClassName) as Class<out Driver?>
            SimpleDriverDataSource().apply {
                setDriverClass(driver)
                url = this@SimpleDataSourceCfg.url
                username = this@SimpleDataSourceCfg.username
                password = this@SimpleDataSourceCfg.password
            }
        } catch (e: Exception) {
