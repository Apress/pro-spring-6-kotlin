 ...
 */
class MessageDigestFactoryBean : FactoryBean<MessageDigest?>, InitializingBean {
    var algorithmName = "MD5"
    private var messageDigest: MessageDigest? = null

    @Throws(Exception::class)
    /** @Implements [FactoryBean.getObject]
     */
    override fun getObject(): MessageDigest? {
        return messageDigest
    }

    /** @Implements [FactoryBean.getObjectType]
     */
    override fun getObjectType(): Class<MessageDigest> {
        return MessageDigest::class.java
    }

    /** @Implements [FactoryBean.isSingleton]
     */
