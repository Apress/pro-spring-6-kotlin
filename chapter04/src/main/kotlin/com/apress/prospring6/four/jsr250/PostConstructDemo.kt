...
class Singer {
    var name: String? = null
        set(value) {
            logger.info("Calling setName for bean of type {}.", com.apress.prospring6.four.intf.Singer::class.java)
            field = value
        }

    var age = Int.MIN_VALUE
        set(value) {
            logger.info("Calling setAge for bean of type {}.", com.apress.prospring6.four.intf.Singer::class.java)
            field = value
        }
...
object PostConstructDemo {
    private val logger = LoggerFactory.getLogger(PostConstructDemo::class.java)
    @JvmStatic
