...
interface AlbumRepository : JpaRepository<Album?, Long?> {
    fun findBySinger(singer: Singer): Iterable<Album>
    fun findWithReleaseDateGreaterThan(rd: LocalDate): Iterable<Album>

    @Query("select a from Album a where a.title like %:title%")
    fun findByTitle(@Param("title") t: String): Iterable<Album>
}