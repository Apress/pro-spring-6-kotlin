...
/**
 * Created by iuliana.cosmina on 07/08/2022
 * IMPORTANT: 	The most important part of the class name that corresponds to the fragment interface is the `Impl` postfix.
 */
