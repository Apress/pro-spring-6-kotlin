 ...
 */
object Chapter10Demo {
    private val LOGGER = LoggerFactory.getLogger(Chapter10Demo::class.java)
    @JvmStatic
    fun main(args: Array<String>) {
        AnnotationConfigApplicationContext(DataJpaCfg::class.java).use { ctx ->
            val service =
                ctx.getBean(
