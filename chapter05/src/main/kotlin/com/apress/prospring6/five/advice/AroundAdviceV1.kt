...
class AroundAdviceV1 {
    ...
    fun simpleAroundAdvice(pjp: ProceedingJoinPoint): Any {
        ...
        LOGGER.info(" > Before Executing: {} from {}", signature.name, signature.declaringTypeName)
        val retVal = pjp.proceed()
        LOGGER.info(" > After Executing: {} from {}", signature.name, signature.declaringTypeName)
        return retVal
    }
