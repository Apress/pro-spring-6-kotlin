...
import com.apress.prospring6.seventeen.boot.controllers.OneSingerController.Companion.setPhoto
...
class SingersController(private val singerService: SingerService, private val messageSource: MessageSource) {
    ...
    fun list(uiModel: Model): String {
        val singers: List<Singer> = singerService.findAll().sortedBy { it.id }
