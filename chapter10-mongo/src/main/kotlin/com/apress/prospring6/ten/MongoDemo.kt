...
object MongoDemo {
    private val LOGGER = LoggerFactory.getLogger(MongoDemo::class.java)
    @JvmStatic
    fun main(args: Array<String>) {
        AnnotationConfigApplicationContext(MongoCfg::class.java).use { ctx ->
            val service: SingerService =
                ctx.getBean(
