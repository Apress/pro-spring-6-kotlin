...
class Singer : AbstractEntity() {
	...
	@NotNull @Size(min = 2, max = 30) var firstName: String? = null

	@Column(name = "LAST_NAME")
	@NotNull @Size(min = 2, max = 30) var lastName: String? = null
	...
	companion object {
		...
		const val FIND_BY_FIRST_AND_LAST_NAME = "Singer.findByFirstAndLastName"
	}
}
