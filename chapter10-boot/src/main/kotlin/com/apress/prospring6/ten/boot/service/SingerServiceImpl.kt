...
@Service
@Transactional
open class SingerServiceImpl(private val singerRepository: SingerRepository) :
    SingerService {
    ...
    @Transactional(readOnly = true)
    override fun findByFirstNameAndLastName(firstName: String, lastName: String): Stream<Singer> {
    ...
    @Transactional(readOnly = true)
    override fun findByLastName(lastName: String): Stream<SingerRepository.FullName> {
