 ...
 */
interface AwardRepo : JpaRepository<Award, Long>,
        JpaSpecificationExecutor<Award> {
    @Query("select a from Award a where a.singer.id =:singerId")
    fun findAwardsBySinger(@Param("singerId") singerId: Long): Iterable<Award>
}
