...
*/
package com.apress.prospring6.three.resource
...
@Configuration
@ComponentScan(basePackages = ["com.apress.prospring6.three.resource"])
internal open class HelloWorldConfiguration()

//  --- bean definitions using @Component and @Resource ---
//simple bean
@Component("provider")
...
internal class StandardOutMessageRenderer() : MessageRenderer {
    override var messageProvider: MessageProvider? = null
        @Resource(name = "provider") set(value) {
            println(" ~~ Injecting dependency using setter & @Resource ~~")
            field = value
        }
