...
*/
package com.apress.prospring6.eighteen.boot.services

import com.apress.prospring6.eighteen.boot.entities.Singer
import com.apress.prospring6.eighteen.boot.problem.NotFoundException
import com.apress.prospring6.eighteen.boot.repos.SingerRepo
...
open class SingerServiceImpl(private val singerRepo: SingerRepo) : SingerService {
    ...
    override fun save(singer: Singer): Singer {
        return singerRepo.save<Singer>(singer)
    }
