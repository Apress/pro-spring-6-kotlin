...
open class JOOQConfig {
    ...
    open fun dslContext(): DSLContext? {
        try {
            ...
            ) // needed because of this: https://blog.jooq.org/mysqls-allowmultiqueries-flag-with-jdbc-and-jooq/
    ...
    companion object {
        private val LOGGER = LoggerFactory.getLogger(JOOQConfig::class.java)
    }
}